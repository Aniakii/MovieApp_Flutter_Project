...
import 'package:movie_app/presentation/screens/all_movies_screen/widgets/header.dart';
...
import '../../../constants/all_movies_screen.dart';
...
class _AllMoviesScreenState extends State<AllMoviesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(appName), automaticallyImplyLeading: false,
      ),
