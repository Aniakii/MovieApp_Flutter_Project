...
mixin _$AllMoviesState {
  ...
  AllMoviesStatus get status => throw _privateConstructorUsedError;
...
class _$AllMoviesStateImpl implements _AllMoviesState {
  ...
  @override
  String toString() {
    return 'AllMoviesState(allMovies: $allMovies, allGenres: $allGenres, status: $status, selectedGenre: $selectedGenre, filteredMovies: $filteredMovies)';
  }
...
abstract class _AllMoviesState implements AllMoviesState {
  const factory _AllMoviesState(
      {required final List<Movie> allMovies,
      required final List<Genre> allGenres,
      required final AllMoviesStatus status,
