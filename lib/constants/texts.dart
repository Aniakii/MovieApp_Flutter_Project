class Alerts {
  ...
  static const String onlineAlertDesc =
      "It seems that you don't have an internet connection to download movie data. Do you want to try again loading data or show data from yours device memory (offline mode)?";
  ...
  static const String offlineAlertDesc =
      "It seems that you haven't used the app yet and there is no data saved on your device. Close the app and open it when you have internet connection.";
  static const String offlineButton = "OK";

  static const String otherAlertTitle = "UNEXPECTED ERROR";
  static const String otherAlertDesc =
      "Unexpected error occurred. It may be due to some issues with API or a bug in code. Try again later or go offline mode.";
